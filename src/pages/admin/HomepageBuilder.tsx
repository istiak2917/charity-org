...
const FALLBACK_SECTION_INFO: Record<string, {
  ...
  impact: {
    ...
    source: "site_settings",
    fields: [
      { key: "impact_label_1", label: "১ম আইটেম লেবেল", settingKey: "impact_label_1" },
      { key: "impact_beneficiaries_count", label: "১ম আইটেম সংখ্যা", settingKey: "impact_beneficiaries_count" },
      { key: "impact_label_2", label: "২য় আইটেম লেবেল", settingKey: "impact_label_2" },
      { key: "impact_projects_count", label: "২য় আইটেম সংখ্যা", settingKey: "impact_projects_count" },
      { key: "impact_label_3", label: "৩য় আইটেম লেবেল", settingKey: "impact_label_3" },
      { key: "impact_volunteers_count", label: "৩য় আইটেম সংখ্যা", settingKey: "impact_volunteers_count" },
      { key: "impact_label_4", label: "৪র্থ আইটেম লেবেল", settingKey: "impact_label_4" },
      { key: "impact_experience_years", label: "৪র্থ আইটেম সংখ্যা", settingKey: "impact_experience_years" },
    ],
    description: "প্রতিটি আইটেমের লেবেল ও সংখ্যা আলাদাভাবে পরিবর্তন করুন",
  },
  faq: {
    label: "FAQ সেকশন",
    source: "site_settings",
