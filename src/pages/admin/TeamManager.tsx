...
interface TeamMember { id: string; name: string; role: string; image_url: string; bio: string; facebook: string; display_order: number; }
...
const TeamManager = () => {
  ...
  const [form, setForm] = useState({ name: "", role: "", image_url: "", bio: "", facebook: "", display_order: 0 });

  const resetForm = () => { setForm({ name: "", role: "", image_url: "", bio: "", facebook: "", display_order: 0 }); setEditing(null); };
  ...
  const handleEdit = (m: TeamMember) => {
    setEditing(m);
    setForm({ name: m.name, role: m.role || "", image_url: m.image_url || "", bio: m.bio || "", facebook: m.facebook || "", display_order: m.display_order });
    setOpen(true);
  };
