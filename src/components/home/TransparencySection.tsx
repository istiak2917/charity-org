      ...
      <div className="container mx-auto px-4">
        <ScrollReveal>
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-bold font-heading mt-2 mb-4">{t("transparency_title")}</h2>
            <div className="w-16 h-1 bg-gradient-to-r from-primary to-accent mx-auto rounded-full" />
            <p className="text-muted-foreground mt-4">{t("transparency_subtitle")}</p>
          </div>
        </ScrollReveal>
