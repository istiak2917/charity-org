          ...
          <div className="max-w-2xl mx-auto">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
              {presets.map((amt, i) => (
                <button
                  key={amt}
                  className="btn-press rounded-2xl border-2 border-primary/20 bg-background py-4 text-lg font-bold text-primary hover:bg-primary hover:text-primary-foreground transition-all duration-300 hover:shadow-lg hover:shadow-primary/15 hover:-translate-y-0.5"
